// Included the IIFE (Immediately-Invoked Function Expression)
(function() {
    ...
    var geo = {
        ...
        function vars() {
            ...
            this.gpsUnavailable = "gpsUnavailable";
            ...
            this.locatieRij = markerRij = [];
            ////////////////////////////////////////////// Wat moet ik met die variable als ik meer objects had gemaakt?
        },
        ...
        function generate_map(myOptions, canvasId) {
            ...
            ET.addListener(this.positionUpdated, update_positie);
        }
